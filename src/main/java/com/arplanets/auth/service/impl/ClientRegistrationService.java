...
import com.arplanets.auth.component.ClientRegistrationRegistry;
...
public class ClientRegistrationService {
    ...
    public ClientRegistrationContext get(String registrationId) {
        return clientRegistrationRegistry.get(registrationId);
    }

    public void register(String userPoolId, ClientRegistration clientRegistration) {
        clientRegistrationRegistry.register(userPoolId, clientRegistration);
    }
    ...
    public void remove(String registrationId) {
        clientRegistrationRegistry.remove(registrationId);
    }
    ...
    public List<String> findRegistrationIdsByPoolId(String poolId) {
        return this.clientRegistrationRegistry.getAll().stream()
    ...
    public String findUserPoolIdByRegistrationId(String registrationId) {
        ...
        ClientRegistrationContext registrationContext = clientRegistrationRegistry.get(registrationId);
